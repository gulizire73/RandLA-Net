...
class Semantic3D:
    def __init__(self):
        ...
        self.path = '/mnt/storage/RandLA-Net-master/data/semantic3d'
        self.label_to_names = {
                               0: 'unlabeled',
                               1: 'ground',
                               2: 'vegetation',
        ...
        self.ascii_files = {
            'newarea1_xyzirgb.ply': 'newarea1_xyzirgb.labels'
            }
    ...
    def get_tf_mapping(self):
        ...
        def tf_map(batch_xyz, batch_features, batch_labels, batch_pc_idx, batch_cloud_idx):
            ...
            for i in range(cfg.num_layers):
                neigh_idx = tf.numpy_function(DP.knn_search, [batch_xyz, batch_xyz, cfg.k_n], tf.int32)
